...
func main() {
   ...
   value := url.Values{}
   value["c"] = []string{"WEB"}
   value["cpn"] = []string{"0I5Kau1O22UZFNbW"}
   value["cver"] = []string{"2.20240926.00.00"}
   value["ei"] = []string{"qXX5ZtvPEv2Z2_gPjerBuQg"}
   value["expire"] = []string{"1727646217"}
   value["fexp"] = []string{"51299152"}
   value["fvip"] = []string{"2"}
   value["id"] = []string{"o-AOjx3hN1pSaRRd3_PIAj40DuwR1fxvZ5WFVqdLSpc0R8"}
   value["initcwndbps"] = []string{"1088750"}
   value["ip"] = []string{"72.181.16.91"}
   value["keepalive"] = []string{"yes"}
   value["lsig"] = []string{"ABPmVW0wRQIhAP2cVPxzbOFWNxXuJiDTq1kTPhTMCq8vuaUGvc5A1w73AiBYGMOlenrh--07zMjL5N9Zn9yN-aEmg1G_XB_Qgz5ErA=="}
   ...
   value["mt"] = []string{"1727624226"}
   value["mv"] = []string{"m"}
   value["mvi"] = []string{"1"}
   value["n"] = []string{"78_onccMq-WDBw"}
   value["ns"] = []string{"1t-Z2QnTKpGR6CZCglhNWvMQ"}
   value["pl"] = []string{"19"}
   value["requiressl"] = []string{"yes"}
   value["rn"] = []string{"5"}
   value["rqh"] = []string{"1"}
   value["sabr"] = []string{"1"}
   value["sig"] = []string{"AJfQdSswRAIgJyZWdWRfpdJmRVhZduPvhaxi5DYr0Gp427j1_wwMDQMCICXlvg1Cxnbf4ydySG0I6N9AWuuKQyWbLvfdC0NZmCWI"}
   value["source"] = []string{"youtube"}
   value["sparams"] = []string{"expire,ei,ip,id,source,requiressl,xpc,spc,svpuc,ns,sabr,rqh"}
   value["spc"] = []string{"54MbxcPragR4oT0P2DMgTIiq-YEXZD2NztrO5K-ISHw6gs-5S0Bh58rgKJCH"}
...
var req_body = protobuf.Message{
   1: {protobuf.Unknown{
      ...
      protobuf.Message{
         ...
         28: {protobuf.Varint(9520)},
         29: {protobuf.Varint(10036)},
         34: {protobuf.Varint(0)},
         36: {protobuf.Varint(10046)},
         39: {protobuf.Varint(10069)},
         46: {protobuf.Varint(1)},
         57: {protobuf.Varint(230)},
            ...
            protobuf.Message{
               1: {protobuf.Unknown{
                  ...
                  protobuf.Message{
                     ...
                     155:       {protobuf.Bytes("bsKWLKPR0rYwUnXjhJ+Z1OrxDce8O0UCDT/n")},
